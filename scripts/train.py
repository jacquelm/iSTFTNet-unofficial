...
if os.path.exists(
    "/home/maxime/Documents/Code/Neural_Network/Pytorch/iSTFTNet-unofficial/src"
):
    sys.path.insert(
        0, "/home/maxime/Documents/Code/Neural_Network/Pytorch/iSTFTNet-unofficial/src"
    )
else:
    sys.path.insert(
        0, "/home/mjacquelin/Project/Neural_Network/Pytorch/iSTFTNet-unofficial/src"
    )
...
def train(a, h):
    ...
    for epoch in range(max(0, last_epoch), a.training_epochs):
        ...
        for _, batch in enumerate(train_loader):
            ...
            print("Disc Per sig", y_df_hat_g.shape)
            print("Disc Per real", fmap_f_r.shape)
            print("Disc Per gen", fmap_f_g.shape)
            print("Disc Amp sig", y_ds_hat_g.shape)
            print("Disc Amp real", fmap_s_r.shape)
            print("Disc Amp gen", fmap_s_g.shape)
            # Loss
...
def main():
    ...
    ## Data/Model
    parser.add_argument(
        "--input_wavs_dir", default="LJSpeech-1.1/wavs"
    )  # Directory directly under which .wav files exist
